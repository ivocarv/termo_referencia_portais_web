...
* Desenvolvimento/alteração de conteúdos multimédia para portais novos ou preexistentes;
* Desenvolvimento/alteração de integrações com outros portais e sistemas;
...
* Esclarecimento de dúvidas de participantes de comunidades de conhecimento montadas em torno das soluções de TI usadas ou desenvolvidas para
...
* O Contratado deve, continuamente e tempestivamente, capacitar e alocar pessoas de perfis e em quantidade adequados, de modo a não comprometer o serviço;
* Os software usados na montagem dos portais evoluam o necessário para não comprometer o serviço;
* A transferência tecnológica deve ser suficiente para que o Contratante não se torne dependente da Contratada ou de terceiros;  
...
* Atualização tecnológica constante dos Portais;
* Revisão constante das informações disponibilizadas nos Portais;
* Possibilidade de melhoria, sob demanda, das aplicações disponíveis nos Portais;
* Facilidade de integração com outras Portais do Governo Federal;
* Sinergia com outros órgãos que utilizam tecnologia similar no Governo Federal;
